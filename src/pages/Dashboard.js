...
function Dashboard() {
  ...
  const handleLogout = () => {
    ...
    localStorage.removeItem("user"); // Also remove the 'user' item if you store it
    navigate("/login");
  };
  ...
  useEffect(() => {
    ...
    if (storedUser) {
      try {
        ...
        // Clear invalid data to avoid further errors
  ...
  }, [phones.length, navigate]); // Add navigate to dependency array
    ...
    <main className="main-content">
      <header className="dashboard-header">
        <div className="user-info">
          ...
          {user && <span className="username">{user.username}</span>} {/* Display username here */}
          <button onClick={handleLogout} className="logout-button"> {/* Changed classname for clarity */}
            Logout
          </button>
        </div>
