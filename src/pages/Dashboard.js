...
function Dashboard() {
  ...
  // This useEffect handles the animated phone number banner
  useEffect(() => {
    const t = setInterval(() => {
    ...
    <main className="main-content">
      <header className="dashboard-header">
        <div className="user-info">
          ...
          {/* This part checks if the user object exists, then displays the username */}
