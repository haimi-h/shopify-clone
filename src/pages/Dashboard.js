...
function Dashboard() {
  ...
  //   navigate("/login");
  // };
  // In Dashboard.js, update your handleLogout function
const handleLogout = () => {
    localStorage.removeItem('user'); // <-- Corrected from 'loggedInUser' to 'user'
    localStorage.removeItem("token");
    navigate("/login");
};
  ...
  useEffect(() => {
    ...
    if (storedUser) {
      try {
        ...
        // Optionally, navigate to login if data is corrupt
        // navigate('/login');
      }
    }
  }, []);
        ...
        <div className="product-scroll">
          {products.map((product, index) => (
            <div
              ...
              onClick={() =>
                navigate("/product-rating", { state: { product } })
              }
            >
              <img
                src={product.image}
          ...
          <div className="partners-logos">
            ...
            <img
              ...
              onError={(e) => {
                e.target.onerror = null;
                e.target.src =
                  "https://placehold.co/64x64/cccccc/white?text=Amazon";
              }}
            />
            <img
              ...
              onError={(e) => {
                e.target.onerror = null;
                e.target.src =
                  "https://placehold.co/64x64/cccccc/white?text=Etsy";
              }}
            />
            <img
              ...
              onError={(e) => {
                e.target.onerror = null;
                e.target.src =
                  "https://placehold.co/64x64/cccccc/white?text=Alibaba";
              }}
            />
          </div>
        </section>
